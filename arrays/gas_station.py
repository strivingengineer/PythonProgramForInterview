...
Approach: We should have any starting and every time we go to the next station as far as possible 
(remained gas is bigger or equal to 0) until we can not (remained gas is less than 0).
Then we must extend our start station to the "last station" ( the station before start station)
...
Why we choosing i+1 stations: Because we know if we run out of fuel say at some ith gas station.
